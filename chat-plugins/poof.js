const messages = [
	...
	"visited Fender's bedroom and never returned!",
	"used Explosion!",
	"fell into the void.",
	"was squished by Nine's large behind!",
	"was terminated by Dcae.bot!",
	"became Zeriloa's love slave!",
